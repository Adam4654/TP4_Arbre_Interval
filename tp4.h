...
//Return la date formater MMDD  0 si date non valide

void deFormater_DayMonth(char [3], char [3], int date);
//Recuperer le jour et le mois de format MMDD

char* deFormaterDate_String(int date);
//retourner date deformater dd/mm

void free_noeud(T_Noeud*);

void afficher_noeud(T_Noeud*);
//print les data d'un observation

void printTeteTab();

void readDate(int* debut, int* fin);
//0 for born superiuer, 1 for born inferiuer
